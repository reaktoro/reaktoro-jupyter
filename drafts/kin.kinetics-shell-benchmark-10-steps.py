...
dt = 1.0
nsteps = 10
result_file_name = "kineticpath-shell-benchmark-nsteps-" + str(nsteps) + ".txt"
...
state = equilibrate(problem_ic)
state.output('shell-kinetics-benchmark-initial.txt')
...
state.setSpeciesMass("Calcite", 100.0869 * 10, "g") #  molar mass of CaCO3 = 100.0869 g/mol
state.setSpeciesMass("Dolomite", 184.4008 * 10, "g") # molar mass of CaMg(CO3)2 = 184.4008 g/mol
state.setSpeciesMass("Halite", 58.44 * 10, "g") # molar mass of NaCl = 58.44 g/mol
state.setSpeciesMass("Quartz", 60.08 * 10, "g") # molar mass of SiO2 = 60.08 g/mol
state.setSpeciesMass("Kaolinite", 258.1604 * 10, "g") # molar mass of Al2Si2O5(OH)4 =  258.1604 g/mol
state.setSpeciesMass("K-Feldspar", 278.3315 * 10, "g") # molar mass of K(AlSi3)O8 = 278.3315 g/mol
# -
...
while n < nsteps:
    ...
    # Solve the kinetics path
    solver.solve(state, t0, dt)
    path.solve(state, t0, t0 + dt, "second")
